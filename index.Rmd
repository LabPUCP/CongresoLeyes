...
```{r, echo=FALSE}
etiquetas=c("Grupo Oficialista", "Propone Ejecutivo")
modelo1 <- coxph(survival ~ GPOficialista + ProponeEjecutivo,data=ModeloCongreso)
stargazer::stargazer(modelo1, type = "text", font.size = "small", 
          apply.coef = exp,
          apply.se   = exp,covariate.labels=etiquetas,note="Nota: se muestran los coeficientes exp.", no.space=T, column.sep.width = "0pt", header=F)
```
