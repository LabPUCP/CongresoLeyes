...
```{r include=FALSE}
proponenteordenado=sort(table(data$proponente), decreasing = T)
proponenteordenado=as.data.frame(proponenteordenado)

#Proponente
data$proponenteR[data$proponente == proponenteordenado[33,1]] = NA
data$proponenteR[data$proponente == proponenteordenado[25,1]] = "BCR"
data$proponenteR[data$proponente == proponenteordenado[29,1]] = "BCR"
data$proponenteR[data$proponente == proponenteordenado[7,1]] = "Colegios Profesionales"
data$proponenteR[data$proponente == proponenteordenado[16,1]] = "Colegios Profesionales"
data$proponenteR[data$proponente == proponenteordenado[15,1]] = "CNM"
data$proponenteR[data$proponente == proponenteordenado[6,1]] = "Gobiernos Regionales"
data$proponenteR[data$proponente == proponenteordenado[9,1]] = "Contraloria"
data$proponenteR[data$proponente == proponenteordenado[11,1]] = "Poder Judicial"
data$proponenteR[data$proponente == proponenteordenado[17,1]] = "Colegios Profesionales"
data$proponenteR[data$proponente == proponenteordenado[1,1]] = "Congreso"
data$proponenteR[data$proponente == proponenteordenado[23,1]] = "CNM"
data$proponenteR[data$proponente == proponenteordenado[30,1]] = "Contraloria"
data$proponenteR[data$proponente == proponenteordenado[20,1]] = "Poder Judicial"
data$proponenteR[data$proponente == proponenteordenado[24,1]] = "Defensoria"
data$proponenteR[data$proponente == proponenteordenado[34,1]] = "Defensoria"
data$proponenteR[data$proponente == proponenteordenado[19,1]] = "Fiscalia"
data$proponenteR[data$proponente == proponenteordenado[5,1]]= "Gobiernos Locales"
data$proponenteR[data$proponente == proponenteordenado[36,1]] = "Gobiernos Regionales"
data$proponenteR[data$proponente == proponenteordenado[14,1]] = "Iniciativas Ciudadanas"
data$proponenteR[data$proponente == proponenteordenado[8,1]] = "JNE"
data$proponenteR[data$proponente == proponenteordenado[27,1]] = "JNE"
data$proponenteR[data$proponente == proponenteordenado[10,1]] = "Gobiernos Locales"
data$proponenteR[data$proponente == proponenteordenado[13,1]] = "Ministerio Publico"
data$proponenteR[data$proponente == proponenteordenado[4,1]] = "Gobiernos Locales"
data$proponenteR[data$proponente == proponenteordenado[18,1]] = "ONPE"
data$proponenteR[data$proponente == proponenteordenado[31,1]] = "ONPE"
data$proponenteR[data$proponente == proponenteordenado[2,1]] = "Poder Ejecutivo"
data$proponenteR[data$proponente == proponenteordenado[3,1]] = "Poder Ejecutivo"
data$proponenteR[data$proponente == proponenteordenado[12,1]] = "Poder Ejecutivo"
data$proponenteR[data$proponente == proponenteordenado[26,1]] = "Poder Judicial"
data$proponenteR[data$proponente == proponenteordenado[28,1]] = "RENIEC"
data$proponenteR[data$proponente == proponenteordenado[21,1]] = "RENIEC"
data$proponenteR[data$proponente == proponenteordenado[22,1]] = "SBS"
data$proponenteR[data$proponente == proponenteordenado[32,1]] = "TC"
data$proponenteR[data$proponente == proponenteordenado[35,1]] = "TC"
```
